...
<ul>
<li><a href="#sec-1">Compatibility and dependencies</a></li>
<li><a href="#sec-2">Installation</a></li>
<li><a href="#sec-3">Usage</a>
<ul>
<li><a href="#sec-3-1">File handling</a></li>
<li><a href="#sec-3-2">Specifying the pixel-rejection method to use</a>
<ul>
<li><a href="#sec-3-2-1">Simple threshold</a></li>
<li><a href="#sec-3-2-2">Edge detection followed by hole filling</a></li>
<li><a href="#sec-3-2-3">Segmentation via watershed transform of the elevation map</a></li>
</ul>
</li>
<li><a href="#sec-3-3">Pruning the list of bad pixel objects</a></li>
<li><a href="#sec-3-4">Manually excluding and including regions</a></li>
<li><a href="#sec-3-5">Which images are saved</a></li>
<li><a href="#sec-3-6">Examples</a></li>
</ul>
</li>
<li><a href="#sec-4">Command line reference</a></li>
</ul>
</div>
</div>
...
# Compatibility and dependencies<a id="sec-1" name="sec-1"></a>
...
## File handling<a id="sec-3-1" name="sec-3-1"></a>
...
## Specifying the pixel-rejection method to use<a id="sec-3-2" name="sec-3-2"></a>
...
### Simple threshold<a id="sec-3-2-1" name="sec-3-2-1"></a>
...
### Edge detection followed by hole filling<a id="sec-3-2-2" name="sec-3-2-2"></a>
...
### Segmentation via watershed transform of the elevation map<a id="sec-3-2-3" name="sec-3-2-3"></a>
...
## Which images are saved<a id="sec-3-5" name="sec-3-5"></a>
...
## Examples<a id="sec-3-6" name="sec-3-6"></a>

    spotless  --data-range 0 10.0 --allow-shadows --output-id cr --verbose --debug F547M

# Command line reference<a id="sec-4" name="sec-4"></a>
